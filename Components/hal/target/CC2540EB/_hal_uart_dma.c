...
#endif
{
  ...
  //add by zhouxiuwu
  //P0SEL |= 0x0C;    //P0.2 - RX, P0.3 - TX as peripheral
 ...
 * @return  None
 ***************************************************************************************************/
extern uint8 g_ucSerComUartTxCnt;
#if (HAL_UART_DMA == 1)
 ...
 * @fn      HalUartGetTxFlag
 *
 * @brief   get the UART transimition is over
 *
 * @param   None
 *
 * @return  1 - Finish; 0 - not
 ***************************************************************************************************/
uint8 HalUartGetTxFlag(void)
{
    #if HAL_UART_TX_BY_ISR
        return dmaCfg.txMT;
    #else
