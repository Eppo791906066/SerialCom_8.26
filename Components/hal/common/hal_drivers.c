...
extern uint16 peripheralStateNotificationRead(void);  //add by zhouxiuwu
/**************************************************************************************************
 * @fn      Hal_ProcessPoll
 *
...
{
    #define NEW_GAPROLE_CONNECTED 5
  /* UART Poll */
#if (defined HAL_UART) && (HAL_UART == TRUE)
//if (NEW_GAPROLE_CONNECTED == peripheralStateNotificationRead())
  HalUARTPoll();
#endif
