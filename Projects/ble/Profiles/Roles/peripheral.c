    ...
    case GAP_DEVICE_INIT_DONE_EVENT:
      {
        ...
        if ( stat == SUCCESS )
        {
          ...
          //add
          gapRole_AdvertData[11] = gapRole_bdAddr[5];
          gapRole_AdvertData[12] = gapRole_bdAddr[4];
          gapRole_AdvertData[13] = gapRole_bdAddr[3];
          gapRole_AdvertData[14] = gapRole_bdAddr[2];
          gapRole_AdvertData[15] = gapRole_bdAddr[1];
          gapRole_AdvertData[16] = gapRole_bdAddr[0];
